...
| Profile | As a User I want to save my profile | Pass | ![testing profile](assets/add-profile.png)
| update-Profile | As a User I want to update my profile | Pass | ![testing profile](assets/add-del.png)
| delete-Profile | As a User I want to remove my profile | Pass | ![testing profile](assets/add-update.png)
| Admin has access to  functionality  | Admin can  delete the customer database | Pass | ![admin testing](assets/admin.png)
